 ...
 *
 */
CoordSolver::CoordSolver(OurPattern ourPattern)
{
    if(ourPattern == blue){
        base_xyz = {};
    }
 ...
 */
double CoordSolver::dynamicCalcPitchOffset(double x, double y, double z)
{
    //TODO:根据陀螺仪安装位置调整距离求解方式
    //降维，坐标系Y轴以垂直向上为正方向
    Eigen::Vector3d xyz = {base_xyz[0] - x, base_xyz[1] - y, base_xyz[2] - z};
