...
namespace upc_radar{
    ...
    class KalmanFilter :public rclcpp::Node
    {
        ...
        int span=0;
        std::array<cv::Point2f,5> tunnel_slanted_,tunnel_horizontal_,supply_,outpost_,little_engine_l_,little_engine_r_,high_way_,hero_location_,self_trapezoidal_,fortress_;
